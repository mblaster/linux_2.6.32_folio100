...
{
    { NvOdmIoModule_I2c, 0x00, 0x04,0 }, /* I2C device address is 0x02, PR: use GEN1_I2C, ER: use GEN2_I2C */
    { NvOdmIoModule_Gpio, (NvU32)'u'-'a', 0x04,0 }, /* GPIO Port U and Pin 4 */
};

//g-sensor
static const NvOdmIoAddress s_AccelerometerAddresses[] =
{
        {NvOdmIoModule_I2c, 0x00, 0x12,0}, /*I2C device address is 0x09*/
        { NvOdmIoModule_Gpio, (NvU32)'v'-'a', 0x07,0 }, /* GPIO Port V and Pin 7 for gsensor, ball: ac24 */
};

// E-compas on GEN1_I2C (I2C_1)
static const NvOdmIoAddress s_EcompassAddressesI2C_1[] =
{
	{ NvOdmIoModule_I2c, 0x00, 0x18,0 },                 /* E compass I2C address is 0x18 */
	{ NvOdmIoModule_Gpio, (NvU32)'v'-'a', 0x01,0 },      /* GPIO Port V and Pin 1 for E-compass  */
};

// Vibrator
static const NvOdmIoAddress s_VibratorAddresses[] =
{
    { NvOdmIoModule_I2c, 0x00, 0x68,0 },
    { NvOdmIoModule_Vdd, 0x00, TPS6586xPmuSupply_PWM,0 },
};

// Cap Sensor on GEN1_I2C (I2C_1)
static const NvOdmIoAddress s_CapSensorAddressesI2C_1[] = 
{
    { NvOdmIoModule_I2c, 0x00, 0x43,0 },            /* GEN1_I2C Cap Sensor I2C address is 0x43     */                                                              
    { NvOdmIoModule_Gpio, (NvU32)'u'-'a', 0x01,0 }, /* GPIO Port U and Pin 1 for CAP_INT  */
...
static const NvOdmIoAddress s_CapSensorAddressesI2C_PWR[] = 
{
    ...
    { NvOdmIoModule_I2c_Pmu, 0x00, 0x43,0 },        /* PWR_I2C Cap Sensor I2C address is 0x43     */                                                            
    { NvOdmIoModule_Gpio, (NvU32)'u'-'a', 0x01,0 }, /* GPIO Port U and Pin 1 for CAP_INT  */
...
{
    { NvOdmIoModule_Gpio, (NvU32)'v'-'a', 0x4,0 },                      /* GPIO Port V and Pin 4 (GPIO_PV4) */
};
...
{
    { NvOdmIoModule_Gpio, (NvU32)'u'-'a', 0x03,0 },                      /* GPIO Port U and Pin 3 (GPIO_PU3) */
};
/* paul merge smith end */
static const NvOdmIoAddress s_PCB_ID_GPIO[] =
{
    { NvOdmIoModule_Gpio, (NvU32)'x'-'a', 0x2,0 },                      /* GPIO Port x and Pin 2 (GPIO_PX2) */
    { NvOdmIoModule_Gpio, (NvU32)'x'-'a', 0x0,0 },                      /* GPIO Port x and Pin 0 (GPIO_PX0) */
};
// USB hub suspend
static const NvOdmIoAddress s_UsbHubSuspendGpio[] =
{
    { NvOdmIoModule_Gpio, (NvU32)'w'-'a', 0x02,0 },                      /* GPIO Port W and Pin 2 (GPIO_PW2) */
};
