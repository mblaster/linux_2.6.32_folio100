...
#ifndef INCLUDED_NVODM_USBOVCUR_H
#define INCLUDED_NVODM_USBOVCUR_H
...
typedef struct NvOdmUsbOvcurRec *NvOdmUsbOvcurDeviceHandle;

typedef struct NvOdmUsbOvcurRec *NvOdmUsbOvcurHandle;


void 
NvOdmUsbOvcurClose(NvOdmUsbOvcurHandle hDevice);

NvBool 
NvOdmUsbOvcurOpen(NvOdmUsbOvcurHandle* hDevice);
